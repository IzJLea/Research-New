...
Tsys=XSteam('Tsat_p',(Peval*10)); %C

% saturation liquid enthalpy

hfsys=XSteam('hL_p',(Peval*10)); %kJ/kg

% saturation vapour enthalpy

hvsys=XSteam('hV_p',(Peval*10)); %kJ/kg
...
rhofsys=XSteam('rhoL_p',(Peval*10));  %kg/m^3

% saturation gas density

rhovsys=XSteam('rhoV_p',(Peval*10)); %kg/m^3

% Cp Liquid  

Cplsys=XSteam('CpL_p',(Peval*10)); %kJ/kg.K

% liquid Thermal Conductivity

klsys=XSteam('tcL_p', (Peval*10)); %W/m.K
...
mulsys=XSteam('my_pT',(Peval*10),(Tsys-1)); %kg/m.s

% Vapour Dynamic Viscosity

muvsys=XSteam('my_pT',(Peval*10),(Tsys+1)); %kg/m.s

% Liquid Prandtl Number

Prlsys=interp1(PCp,Prl,(Peval)); 
...
Qlossval=Qloss(1);
%% Pressure Tube/Calandria tube Temperatures

TIPT=Tbulk-(Qlossval*1000000*R1);

TOPT=TIPT-(Qlossval*1000000*R2);

TICT=TOPT-(Qlossval*1000000*R3);
